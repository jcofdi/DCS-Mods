...
{
    float3 q1_xyz = float3(q1.x, q1.y, q1.z);
    float3 q2_xyz = float3(q2.x, q2.y, q2.z);
    
    return float4(
        q2.xyz * float3(q1.w, q1.w, q1.w) + q1.xyz * float3(q2.w, q2.w, q2.w) + cross(q1.xyz, q2.xyz),
        q1.w * q2.w - dot(q1.xyz, q2.xyz)
    );
    
    /*
    return float4(
        q2_xyz * float3(q1.w, q1.w, q1.w) + q1_xyz * float3(q2.w, q2.w, q2.w) + cross(q1_xyz, q2_xyz),
        q1.w * q2.w - dot(q1_xyz, q2_xyz)
    );
        */
}
...
float4 q_slerp(IN float4 a, IN float4 b, float t)
{
    ...
    float4 result = float4(blendA * float3(a.xyz) + blendB * float3(b.xyz), blendA * a.w + blendB * b.w);
