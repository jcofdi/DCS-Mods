Rain =
{
	...
	verticalSpeed = {15, 15}, -- мин | макс вертикальная скорость падени¤ капли при слабом дожде, м/с
	...
	particleJitterVelocity = {0.045, 0.045}, -- скорость плавани¤ частиц дымки в горизонтальной плоскости, мин | макс
