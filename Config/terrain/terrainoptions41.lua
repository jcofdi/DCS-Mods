...
instancer =
{
	computeStrategy = "single"; -- { "separate", "single" }
	...
	-- for single compute strategy
	singleBufferSize = 4194304; -- max cached instances count
	singleBlockSize = 128;      -- instance count in block
