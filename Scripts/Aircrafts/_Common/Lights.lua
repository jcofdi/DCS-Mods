...
WOLALIGHT_CABIN_WORK       = 14



SpotLigtPositions = { -- 1я фара всегда посадочная
-- 1 spot
--[ FA_18]		={{3.279, -0.599,  0.0}},		-- Moved to CoreMods
...
lamp_prototypes = {
    LFS_P_27_200 = { -- landing lamp / combo, 200 Wt, 200 kcd, 145mm, LFS-PR27-200+130 / ЛФС-ПР27-200+130
    ...
    LFS_P_27_450 = { -- landing lamp / combo, 450 Wt, 260 kcd, 145mm, LFS-PR27-450+250 / ЛФС-ПР27-450+250
    ...
    LFS_P_27_600 = { -- landing lamp / combo, 600 Wt, 400 kcd, 205mm, LFS-PR27-600+180 / ЛФС-ПР27-600+180
    ...
    LFS_P_27_1000 = { -- landing lamp / combo, 1000 Wt, 540 kcd, 205mm, LFS-PR27-1000+450 / ЛФС-ПР27-1000+450
    ...
    LFS_R_27_130 = { -- taxi lamp / combo, 130 Wt, 16 kcd, 145mm, LFS-PR27-200+130 / ЛФС-ПР27-200+130
    ...
    LFS_R_27_180 = { -- taxi lamp / combo, 180 Wt, 25 kcd, 205mm, LFS-PR27-600+180 / ЛФС-ПР27-600+180
    ...
    LFS_R_27_250 = { -- taxi lamp / combo, 250 Wt, 51 kcd, 145mm, LFS-PR27-450+250 / ЛФС-ПР27-450+250
    ...
    LFS_R_27_450 = { -- taxi lamp / combo, 450 Wt, 80 kcd, 205mm, LFS-PR27-1000+450 / ЛФС-ПР27-1000+450
    ...
    LFS_Z_27_250 = { -- refueling lamp, 250 Wt, 70 kcd, 145mm, LFS-Z27-250 / ЛФС-З27-250
        color = {255, 201, 125, 0.012 * math.sqrt(250) + 0.024}, range = 0.012 * 70000, angle_max = math.rad(44.0), angle_min = math.rad(44.0 * 0.8),
        power_up_t = 0.75,
    },
    FR_100 = { -- aux / taxi lamp, 70 Wt, 5 kcd, FR-100 / ФР-100
        color = {255, 201, 125, 0.012 * math.sqrt(75) + 0.024}, range = 250, angle_max = math.rad(28.0),
    },
    FPK_250 = { -- wing edge and nacelle illumination lamp, 250 Wt, 51 kcd, 128mm, FPK-250 / ФПК-100
        color = {255, 201, 125, 0.012 * math.sqrt(250) + 0.024}, range = 0.012 * 51000, angle_max = math.rad(44.0), angle_min = math.rad(12.0),
        power_up_t = 1.55,
    },
    FPP_7 = { -- search / landing lamp, 480 Wt, 300 kcd, 160mm, FPP-7M / ФПП-7М
    ...
    FPP_7_halo = { -- search / landing lamp, 480 Wt, 30 kcd, 160mm, FPP-7M / ФПП-7М
    ...
    SMI_2KM = { -- strobe lamp, red, SMI-2KM / СМИ-2КМ
    ...
    MPS_1 = { -- strobe lamp, moon white, MPS-1 / МПС-1
    ...
    MSL_3_2 = { -- beacon assy, 2x, red, MSL-3-2s / МСЛ-3-2с
    ...
    MSL_4 = { -- beacon assy, 1x, white, MSL-4 / МСЛ-4
        --connector = "RED_BEACON",
    ...
    MSL_4K = { -- beacon assy, 1x, red, MSL-4K / МСЛ-4К
        --connector = "RED_BEACON",
...
-- F/A-18C
--lights_prototypes[FA_18C] = lights_prototypes[FA_18] -- TODO duplicated - Made Dragon	-- Moved to CoreMods
...
lights_prototypes[Su_30] = {
    ...
    lights = {
		...
		[WOLALIGHT_SPOTS] = {
            ...
            lights = {
						{
                            typename = "Spot", position = {	5.439, -0.318, 0.121},
							direction = {azimuth = math.rad(-2.0), elevation = math.rad(9.0)},
                            proto = lamp_prototypes.LFS_P_27_1000,
                            exposure = {{0, 0.98, 1.0}}, movable = true,
                        },
						{
                            typename = "Omni", position = {5.439 + 0.25, -0.318, 0.121},
                            proto = lamp_prototypes.LFS_P_27_1000, range = 4.0,
							exposure = {{0, 0.98, 1.0}}, movable = true,
                        },
						{
                            typename = "Spot", position = { 5.4, -0.234, -0.154},
							direction = {azimuth = math.rad(2.0), elevation = math.rad(10.0)},
                            proto = lamp_prototypes.LFS_P_27_1000,
                            exposure = {{0, 0.98, 1.0}}, movable = true,
                        },
						{
                            typename = "Omni", position = {5.4 + 0.25, -0.234, -0.154},
                            proto = lamp_prototypes.LFS_P_27_1000, range = 4.0,
							exposure = {{0, 0.98, 1.0}}, movable = true,
                        },
						{
                            typename = "Spot", position = {5.501, -0.675, -0.002},
							direction = {elevation = math.rad(7.0)},
                            proto = lamp_prototypes.LFS_R_27_450,
                            exposure = {{0, 0.98, 1.0}}, movable = true,
                        },
						{
                            typename = "Omni", position = {5.501 + 0.2,  -0.675, -0.002},
                            proto = lamp_prototypes.LFS_R_27_450, range = 3.0,
							exposure = {{0, 0.98, 1.0}}, movable = true,
                        },
            }
        },
		...
		[WOLALIGHT_CABIN_NIGHT] = {
            ...
            lights = {
                [1] = {
                    ...
                    lights = {
                        {
                            typename = "Omni", position = {8.4, 1.08, 0.0},
                            color = {0.0, 1.0, 0.0, 0.3}, range = 2.0,
                        },
                        {
                            typename = "Omni", position = {6.9, 1.48, 0.00},
                            color = {0.0, 1.0, 0.0, 0.3}, range = 2.0,
                        },
                    },
                },
...
lights_prototypes[TORNADO_IDS] = {
    ...
    lights = {
		...
		[WOLALIGHT_SPOTS] = {
            ...
            lights = {
						{
                            typename = "Spot", position = {	0.45, -0.76, 1.7},
							direction = {azimuth = math.rad(-2.0), elevation = math.rad(9.0)},
                            proto = lamp_prototypes.LFS_P_27_1000,
                            exposure = {{3, 0.7, 1.0}}, movable = true,
                        },
						{
                            typename = "Omni", position = {0.45 + 0.25, -0.76, 1.7},
                            proto = lamp_prototypes.LFS_P_27_1000, range = 4.0,
							exposure = {{3, 0.7, 1.0}}, movable = true,
                        },
						{
							...
							direction = {azimuth = math.rad(2.0), elevation = math.rad(10.0)},
                            proto = lamp_prototypes.LFS_P_27_1000,
                            exposure = {{5, 0.7, 1.0}}, movable = true,
                        },
						{
                            typename = "Omni", position = {0.45 + 0.25, -0.76, -1.7},
                            proto = lamp_prototypes.LFS_P_27_1000, range = 4.0,
        ...
        [WOLALIGHT_TAXI_LIGHTS] = {
            ...
            lights = {
						{
                            typename = "Spot", position = {4.235, -1.26, 0.047},
							direction = {elevation = math.rad(7.0)},
                            proto = lamp_prototypes.LFS_R_27_450,
                            exposure = {{0, 0.98, 1.0}}, movable = true,
                        },
						{
                            typename = "Omni", position = {4.235+0.2, -1.26, 0.047},
                            proto = lamp_prototypes.LFS_R_27_450, range = 3.0,
							exposure = {{0, 0.98, 1.0}}, movable = true,
                        },
            }
		...
		[WOLALIGHT_CABIN_NIGHT] = {
            ...
            lights = {
                [1] = {
                    ...
                    lights = {
                        {
                            typename = "Omni", position = {4.5, 0.95, 0.0},
                            color = {0.0, 1.0, 0.0, 0.3}, range = 2.0,
                        },
                        {
                            typename = "Omni", position = {2.85, 0.96, 0.00},
                            color = {0.0, 1.0, 0.0, 0.2}, range = 2.0,
                        },
                    },
                },
            },
...
lights_prototypes[MI_8MT] = {
    ...
    lights = {
        [WOLALIGHT_NAVLIGHTS] = {
            ...
            lights = {
                {
                    typename = "spotlight", connector = "BANO_0", argument = 195, dir_correction = {azimuth = math.rad(180.0)},
                    proto = lamp_prototypes.ANO_3_Bl,
                    power_up_t = 1e-6,
                },
                {
                    typename = "spotlight", connector = "BANO_1", argument = 190, dir_correction = {azimuth = math.rad(-90.0), elevation = math.rad(-45.0)},
                    proto = lamp_prototypes.ANO_3_Kr,
                    exposure = {{1000, 0.0, 1.0, 1.0, 0.0}}, power_up_t = 1e-6,
                },
                {
                    typename = "spotlight", connector = "BANO_3", argument = 192, dir_correction = {azimuth = math.rad(-90.0), elevation = math.rad(-45.0)},
                    proto = lamp_prototypes.ANO_3_Kr,
                    exposure = {{80, 0.0, 1.0, 1.0, 0.0}}, power_up_t = 1e-6,
                },
                {
                    typename = "spotlight", connector = "BANO_2", argument = 191, dir_correction = {azimuth = math.rad(-90.0), elevation = math.rad(45.0)},
                    proto = lamp_prototypes.ANO_3_Zl,
                    exposure = {{1000, 0.0, 1.0, 1.0, 0.0}}, power_up_t = 1e-6,
                },
                {
                    typename = "spotlight", connector = "BANO_4", argument = 194, dir_correction = {azimuth = math.rad(-90.0), elevation = math.rad(45.0)},
                    proto = lamp_prototypes.ANO_3_Zl,
                    exposure = {{80, 0.0, 1.0, 1.0, 0.0}}, power_up_t = 1e-6,
                },
            },
            ...
            lights = {
                {
                    ...
                    lights = {
                        ...
                        {
                            typename = "spotlight", connector = "MAIN_SPOT_PTR", dir_correction = {azimuth = math.rad(0), elevation = math.rad(4)},
                            proto = lamp_prototypes.FR_100,
                        },
                        {
                            typename = "spotlight", connector = "MAIN_SPOT_PTR", dir_correction = {azimuth = math.rad(11), elevation = math.rad(4)},
                            proto = lamp_prototypes.FR_100,
                        },
                        {
                            typename = "spotlight", connector = "MAIN_SPOT_PTR", dir_correction = {azimuth = math.rad(22), elevation = math.rad(4)},
                            proto = lamp_prototypes.FR_100,
                        },
                        {
                            typename = "spotlight", connector = "MAIN_SPOT_PTR", dir_correction = {azimuth = math.rad(-11), elevation = math.rad(4)},
            ...
            lights = {
                ...
                },
                {
                    ...
                    lights = {
                        ...
                        {
                            typename = "spotlight", connector = "RESERV_SPOT_PTR_2",
                            proto = lamp_prototypes.FPP_7_halo,
                            movable = true,
                        },
                    },
