...
function loadOptions()
	local func, err = base.loadfile(ConfigHelper.getUserOptionsPathRead())
	...
	if product_options and lfs.attributes(ConfigHelper.getUserOptionsPathWrite()) == nil then
...
function saveOptions()
	if options then
		local file, err = base.io.open(ConfigHelper.getUserOptionsPathWrite(), 'w')
