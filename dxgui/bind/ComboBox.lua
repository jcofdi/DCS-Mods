...
function setEnableSearchLine(self, enableSearchLine)
	gui.ComboBoxSetEnableSearchLine(self.widget, enableSearchLine)
end

function getEnableSearchLine(self)
	return gui.ComboBoxGetEnableSearchLine(self.widget)
end

function setHintText(self, hintText)
	gui.ComboBoxSetHintText(self.widget, hintText)
end

function getHintText(self)
	return gui.ComboBoxGetHintText(self.widget)
end
