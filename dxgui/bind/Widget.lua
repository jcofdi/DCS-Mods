...
-- возвращает x, y до указанного виджета родителя parent, если parent не родитель, то возвращает входные x, y
-- не явно работает если parent это Window, тк всё одержимое находится в WindowView чей родитель Window
-- в таком случае нужно вычитать высоту WindowHeader при необходимости
function widgetToParentWidget(self, x, y, parent)
	return gui.WidgetToParentWidget(self.widget, x, y, parent)
end
